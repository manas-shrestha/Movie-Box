 ...
 */
public class UpComingMovies extends Fragment implements ChangeToolbarTitle {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        changeToolbarTitle.changeTitle("Up Coming");
        return v;
    }
    ...
    private void requestData() {
        ...
        api.getUpComing(new Callback<MostPopular>() {
            @Override
